...
function Products() {
  ...
  const handleClick = (value, type, event) => {
    ...
    if (type === "product_style") {
      ...
      filtered = filtered.filter(
        (product) => product.product_style === product_style
      );
      setProducts(filtered); // 設置回初始值
      // console.log('初始值：', originalProduct);
    ...
    switch (value) {
      case "50":
        Productsfilter = Productsfilter.filter((product) => {
          return product.height >= 50 && product.height <= 100;
        });
      ...
      case "100":
        Productsfilter = Productsfilter.filter((product) => {
          return product.height >= 100 && product.height <= 300;
        });
        break;
      case "300":
        Productsfilter = Productsfilter.filter((product) => {
          return product.height >= 300 && product.height <= 400;
        });
        break;
      case "400":
        Productsfilter = Productsfilter.filter((product) => {
        ...
        <section id="Products__section">
          <aside id="Products__aside">
            <table className="Products＿aside-content-center">
                ...
                <Dropdown>
                  ...
                  <Dropdown.Menu>
                    <Dropdown.Item
                      value="所有"
                      onClick={() =>
                        handleProduct_styleRange("所有", "product_style")
                      }
                    >
                      所有
                    </Dropdown.Item>
                    <Dropdown.Item
                      value="印象"
                      onClick={() => handleClick("印象", "product_style")}
                    >
                      印象
                    </Dropdown.Item>
                    <Dropdown.Item
                      value="幾何"
                      onClick={() => handleClick("幾何", "product_style")}
                    >
                      幾何
                    </Dropdown.Item>
                    <Dropdown.Item
                      value="復古"
                      onClick={() => handleClick("復古", "product_style")}
                    >
                      復古
                    </Dropdown.Item>
                    <Dropdown.Item
                      value="超現實"
                      onClick={() => handleClick("超現實", "product_style")}
                    >
                      超現實
                    </Dropdown.Item>
                    <Dropdown.Item
                      value="水彩"
                      onClick={() => handleClick("水彩", "product_style")}
                    >
                      水彩
                    </Dropdown.Item>
                    <Dropdown.Item
                      value="表現主義"
                      onClick={() => handleClick("表現主義", "product_style")}
                    >
                      表現主義
                    </Dropdown.Item>
                  </Dropdown.Menu>
                ...
                <table>
                  <tr>
                    {["Red"].map((work_hue) => (
                      <td>
                        <div
                          className={
                            "Products＿slider-color-item Products＿slider-color-item-red"
                          }
                          value={work_hue}
                    ...
                    {["Orange"].map((work_hue) => (
                      <td>
                        <div
                          className="Products＿slider-color-item Products＿slider-color-item-ori"
                          value={"work_hue"}
                          onClick={() => handleClick(work_hue, "work_hue")}
                        ></div>
                      </td>
                    ...
                    {["Yellow"].map((work_hue) => (
                      <td>
                        <div
                          className="Products＿slider-color-item Products＿slider-color-item-yel"
                          value={"Yellow"}
                          onClick={() => handleClick(work_hue, "work_hue")}
                        ></div>
                      </td>
                    ...
                    {["Green"].map((work_hue) => (
                      <td>
                        <div
                          className="Products＿slider-color-item Products＿slider-color-item-gre"
                          value={"Green"}
                          onClick={() => handleClick(work_hue, "work_hue")}
                        ></div>
                      </td>
                  ...
                  <tr>
                    {["Blue"].map((work_hue) => (
                      <td>
                        <div
                          className="Products＿slider-color-item Products＿slider-color-item-blu"
                          value={"Blue"}
                          onClick={() => handleClick(work_hue, "work_hue")}
                        ></div>
                      </td>
                    ...
                    {["Purple"].map((work_hue) => (
                      <td>
                        <div
                          className="Products＿slider-color-item Products＿slider-color-item-pur"
                          value={"Purple"}
                          onClick={() => handleClick(work_hue, "work_hue")}
                        ></div>
                      </td>
                    ...
                    {["Brown"].map((work_hue) => (
                      <td>
                        <div
                          className="Products＿slider-color-item Products＿slider-color-item-bro"
                          value={"Brown"}
                          onClick={() => handleClick(work_hue, "work_hue")}
                        ></div>
                      </td>
                    ...
                    {["White"].map((work_hue) => (
                      <td>
                        <div
                          className="Products＿slider-color-item Products＿slider-color-item-whi"
                          value={"White"}
                          onClick={() => handleClick(work_hue, "work_hue")}
                        ></div>
                      </td>
                  ...
                  <tr>
                    {["Gray"].map((work_hue) => (
                      <td>
                        <div
                          className="Products＿slider-color-item Products＿slider-color-item-gra"
                          value={"Gray"}
                          onClick={() => handleClick(work_hue, "work_hue")}
                        ></div>
                      </td>
                    ...
                    {["Black"].map((work_hue) => (
                      <td>
                        <div
                          className="Products＿slider-color-item Products＿slider-color-item-bla"
                          value={"Black"}
                          onClick={() => handleClick(work_hue, "work_hue")}
                        ></div>
                      </td>
              ...
              <h5
                className="Products＿slider-color-size-h6"
                onClick={handleClear}
              >
                長邊{selectedWidth}
              </h5>
          ...
          <nav id="Products＿nav">
            <div className="Products＿nav__h3 d-flex">
              <ProductsBurger classMame="ProductsBurger"></ProductsBurger>
              <h2 className="ms-2">所有藝術品</h2>
            </div>
              ...
              <div className="Products＿link-bar ">
                ...
                <p className="Products＿link ">
                  ...
                  <Link onClick={handleClear}>
                    所有藝術品▶ {product.length} 件 {selectedMaterial}{" "} {formatObject(selectedWork_hue)}
                  </Link>
                </p>
                <Dropdown>
                  <Dropdown.Toggle
                  ...
                  <>
                    <div className="Products__img-id-wrap">
                      <a href={`/products/${product_data.id}`}>
                        ...
                        />
                        <h4 className="Products__productId">
                          {product_data.name}
                        </h4>
                        <p className="Products__material mb-0">
                          {product_data.material},{product_data.creation_year}
                          <span className="ms-2"></span>
                        </p>
                        <p className="Products__article">
                          {product_data.artist}
                        </p>
          ...
          <footer id="Products__footer"></footer>
        </section>
