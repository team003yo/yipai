        ...
        <div className="sellerhome__sidebar">
          <div className="sellerhome__sidebar__center">
            <div className="_sellerhome__pic_1920 m-3">
              ...
              <div className='sellerhome_buyLogin_headIcon_flex'>
              <div className="sellerhome_buyLogin_headIcon">
                {/* 增加檔案 */}
                  <input
                    type="file"
                    id="imageHead"
              ...
              <Button className="_buyLogin_imageHead_Button" onClick={handleSellerPicSubmit}>送出</Button>
            </div>
            </div>
